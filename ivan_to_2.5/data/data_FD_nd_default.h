...
const int     SAVE_COUPE_INTERPOLATION=0; //- if 1 then uses interpolation. Use 0 for testing purposes (to compare VFxx.dat and coupexx.dat files)
...
// -------------------
      int     FORMAT_FULLDATA         = 0; //- furthermore add (at left) the list of indexes corresponding to the current point {files VF.dat, etc.}
      int     SHOW_COORDINATES        = 0; //- will furthermore add (at right) the list of coordinates on each line of the {VF.dat, etc.} files 
