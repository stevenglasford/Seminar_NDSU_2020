...
if ( draw_surf )
	...
	title( 'V \cdot 10^{-4} ,  (b) \tau = 5 (t = 55)', 'fontsize', 25, 'fontname', 'Franklin Gothic Book' );
    ...
    print -color "-S600,400" 'Value_function_tau=5.eps'
...
if (draw_controls)
	...
	title( 'u_1 ,  (b) \tau = 5 (t = 55)', 'fontsize', 25, 'fontname', 'Franklin Gothic Book' );
	...
	print -color "-S600,400" 'u_1_tau=5.eps'
	...
	title( 'u_2 ,  (b) \tau = 5 (t = 55)', 'fontsize', 25, 'fontname', 'Franklin Gothic Book' );
	...
	print -color "-S600,400" 'u_2_tau=5.eps'
