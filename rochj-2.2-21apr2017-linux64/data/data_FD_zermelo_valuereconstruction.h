...
const char    NAME[]            = "data_FD_zermelo_valuereconstruction.h;  Date: Apr. 2014\nO. Bokanowski, A. Desilles, H. Zidani";
...
int TRAJPT = 3;     double initialpoint[3*DIM]={-3.0, 1.8, 0.0, 1.5, -3.0, -1.5};     //- Initial point for HJB
