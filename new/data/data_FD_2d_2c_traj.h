...
const char    NAME[150]         = "data_DF_2d_2c_traj.h (HJ Issacs equation, Mar. 2013 (OB, AD, HZ)";
...
const double                   T= 0.60;        //- Terminal time
...
const double  XMIN[DIM]         = { -2.5 , -2.0};
const double  XMAX[DIM]         = {  2.5 ,  2.0};           //- bound of the domain
