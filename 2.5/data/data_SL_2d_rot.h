...
//-    v(0,x)=v0(x)
//----------------------------------------
#include "data_SL_2d_rot_default.h"	// do not modify for basic examples
//----------------------------------------
...
const int     SAVE_VF_ALL       = 0;       //- 1 to save "VFn.dat" every  SAVE_VFALL_STEP iterations
...
const int     CHECK_NEG_POINTS  = 1;       //- 1/0 : to print number of negative point in domain and domain + boundary (default : 0)
