...
char          XuserToptFile0[]  = "XuserVtopt";// will be completed by ".dat" or "n.dat" extention 
      ...
      int     SAVE_COUPE_INTERPOLATION=1; //- if 1 then uses interpolation. Use 0 for testing purposes (to compare VFxx.dat and coupexx.dat files)
