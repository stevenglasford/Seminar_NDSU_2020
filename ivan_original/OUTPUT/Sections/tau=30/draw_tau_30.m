...
if ( draw_surf )
	...
	title( 'V \cdot 10^{-4} ,  (d) \tau = 30 (t = 30)', 'fontsize', 25, 'fontname', 'Franklin Gothic Book' );
    ...
    print -color "-S600,400" 'Value_function_tau=30.eps'
...
if (draw_controls)
	...
	title( 'u_1 ,  (d) \tau = 30 (t = 30)', 'fontsize', 25, 'fontname', 'Franklin Gothic Book' );
	...
	print -color "-S600,400" 'u_1_tau=30.eps'
	...
	title( 'u_2 ,  (d) \tau = 30 (t = 30)', 'fontsize', 25, 'fontname', 'Franklin Gothic Book' );
	...
	print -color "-S600,400" 'u_2_tau=30.eps'
