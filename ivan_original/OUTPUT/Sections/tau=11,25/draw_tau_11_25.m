...
surf_axis_limits = [0.1, 0.7, 0.1, 0.7, -0.5, 0.5];
...
if ( draw_surf )
	...
	surf( X_part, Y_part, value_func_part, 'edgecolor', 'black' );
	
	title( 'V \cdot 10^{-4} ,  (c) \tau = \tau^{**} \approx 11.175 (t \approx 48.825)', 'fontsize', 25, 'fontname', 'Franklin Gothic Book' );
    ...
    print -color "-S600,400" 'Value_function_tau=11,25.eps'
...
if (draw_controls)
	...
	title( 'u_1 ,  (c) \tau = \tau^{**} \approx 11.175 (t \approx 48.825)', 'fontsize', 25, 'fontname', 'Franklin Gothic Book' );
	...
	print -color "-S600,400" 'u_1_tau=11,25.eps'
	...
	title( 'u_2 ,  (c) \tau = \tau^{**} \approx 11.175 (t \approx 48.825)', 'fontsize', 25, 'fontname', 'Franklin Gothic Book' );
	...
	print -color "-S600,400" 'u_2_tau=11,25.eps'
