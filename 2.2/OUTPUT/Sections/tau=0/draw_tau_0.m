...
if ( draw_surf )
	...
	title( 'V \cdot 10^{-4} ,  (a) \tau = 0 (t = T = 60)', 'fontsize', 25, 'fontname', 'Franklin Gothic Book' );
    ...
    print -color "-S600,400" 'Value_function_tau=0.eps'
...
if (draw_controls)
	...
	title( 'u_1 ,  (a) \tau = 0 (t = T = 60)', 'fontsize', 25, 'fontname', 'Franklin Gothic Book' );
	...
	print -color "-S600,400" 'u_1_tau=0.eps'
	...
	title( 'u_2 ,  (a) \tau = 0 (t = T = 60)', 'fontsize', 25, 'fontname', 'Franklin Gothic Book' );
	...
	print -color "-S600,400" 'u_2_tau=0.eps'
